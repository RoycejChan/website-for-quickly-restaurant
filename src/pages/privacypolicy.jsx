    ...
    return (
        <div className="privacy-policy-container container">
            <div className="privacy-policy-header">
                <h1 className="privacy-policy-company-name">
                    Quickly, Inc.
                </h1>
                <h1 className="privacy-policy-title">
                    Privacy Policy
                </h1>
                <h2 className="privacy-policy-effective-date">
                Your privacy is critically important to us.
                </h2>
                <div className="llc-location">
                    <p className="llc-header">
                    Universal Processing LLC is located at:
                    </p>
                    <p className="llc-location-details">
            ...
            <div className="privacy-policy-agreement-message">
                <p className="privacy-policy-main-message">
                        ...
                        <br /> <br />
                        <bold className="privacy-bold"> - Protection of Certain Personally-Identifying Information</bold>
                        <br /> <br />
