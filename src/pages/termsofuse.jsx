...
export default function Termsofuse() {
    return (
        <div className="tou-container container">
            <div className="tou-header">
                <h1 className="tou-company-name">
                    Quickly, Inc.
                </h1>
                <h1 className="tou-title">
                    Terms of Agreement
                </h1>
                <h2 className="tou-effective-date">
            ...
            <div className="tou-agreement-message">
                ...
                <br/> <br/>
                <bold className="tou-bold">INTELLECTUAL PROPERTY RIGHTS</bold>
                <br/> <br/>
                ...
                <br/> <br/>
                <bold className="tou-bold">USER REGISTRATION</bold>
                <br/> <br/>
                ...
                <br/> <br/>
                <bold className="tou-bold">MARKETPLACE OFFERINGS</bold>
                <br/> <br/>
                ...
                <br/> <br/>
                <bold className="tou-bold">PURCHASES AND PAYMENT</bold>
                <br/> <br/>
                ...
                You agree to provide current, complete, and accurate purchase and account information for all purchases of the Marketplace Offerings made via the Site. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be inU.S. dollars.  
                ...
                <br/> <br/>
                <bold className="tou-bold">RETURN POLICY</bold>
                <br/> <br/>
                All sales are final and no refund will be issued.
                
                <br/> <br/>
                <bold className="tou-bold">SITE MANAGEMENT</bold>
                <br/> <br/>
                ...
                <br/> <br/>
                <bold className="tou-bold">PRIVACY POLICY</bold>
                <br/> <br/>
                We care about data privacy and security. By using the Site or the Marketplace Offerings, you agree to be bound by our Privacy Policy posted on the Site, which is incorporated into these Terms of Use. Please be advised the Site and the Marketplace Offerings are hosted in theUnited States. If you access the Site or the Marketplace Offerings from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in theUnited States, then through your continued use of the Site, you are transferring your data to theUnited States, and you agree to have your data transferred to and processed in theUnited States.
                
                <br/> <br/>
                <bold className="tou-bold">TERM AND TERMINATION</bold>
                <br/> <br/>
                These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SITE AND THE MARKETPLACE OFFERINGS (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BRACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS OF USE OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE AND THE MARKETPLACE OFFERINGS OR DELETEYOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION. 
                
                If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party. In addition to terminating or suspending your account, we reserve the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.
                <br/> <br/>
                <bold className="tou-bold">GOVERNING LAW</bold>
                <br/> <br/>
                These Terms of Use and your use of the Site and the Marketplace Offerings are governed by and construed in accordance with the laws of the State ofNew Yorkapplicable to agreements made and to be entirely performed within the State ofNew York, without regard to its conflict of law principles.
                
                <br/> <br/>
                <bold className="tou-bold">DISPUTE RESOLUTION</bold>
                <br/> <br/>
                <bold className="tou-bold">Restrictions</bold>
                <br/> <br/>
                The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brught in a purported representative capacity on behalf of the general public or any other persons.
                <br/> <br/>
                <bold className="tou-bold">Exceptions to Informal Negotiations and Arbitration</bold>
                <br/> <br/>
                ...
                <br/> <br/>
                <bold className="tou-bold">CORRECTIONS</bold>
                <br/> <br/>
                There may be information on the Site that contains typographical errors, inaccuracies, or omissions that may relate to the Marketplace Offerings, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice.
                
                <br/> <br/>
                <bold className="tou-bold">DISCLAIMER</bold>
                <br/> <br/>
                ...
                <br/> <br/>
                <bold className="tou-bold">MISCELLANEOUS</bold>
                <br/> <br/>
                ...
                <br/> <br/>
                <bold className="tou-bold">CONTACT US</bold>
                <br/> <br/>
